USE ServiceMac;
GO
DROP PROC IF EXISTS Processing.Update_History_Data_Static_Proc_Generator;
GO
CREATE PROCEDURE Processing.Update_History_Data_Static_Proc_Generator
...
SET @GenerateStaticProc += CONCAT('							
	...
	WHERE RecordStartDate = @EffectiveDate
			AND $PARTITION.pf_DateByMonthRight(L.RecordStartDate) = $PARTITION.pf_DateByMonthRight(@EffectiveDate);
	...
	AND $PARTITION.pf_DateByMonthRight(History.RecordEndDate) = $PARTITION.pf_DateByMonthRight(@RecordEndDate)
